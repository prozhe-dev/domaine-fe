document.addEventListener("shopify:section:load", function (e: Event) {
...
document.addEventListener("shopify:section:unload", function (e: Event) {
  const event = e as ShopifyEvent;
  const section_id = event.detail.sectionId;
  const section_container = (event.target as HTMLElement).querySelector(`[data-section-id='${section_id}']`) as ShopifyWebComponentSection;
...
document.addEventListener("shopify:section:select", function (e: Event) {
  const event = e as ShopifyEvent;
  const section_id = event.detail.sectionId;
  const section_container = (event.target as HTMLElement).querySelector(`[data-section-id='${section_id}']`) as ShopifyWebComponentSection;
...
document.addEventListener("shopify:section:deselect", function (e: Event) {
  const event = e as ShopifyEvent;
  const section_id = event.detail.sectionId;
  const section_container = (event.target as HTMLElement).querySelector(`[data-section-id='${section_id}']`) as ShopifyWebComponentSection;
...
document.addEventListener("shopify:block:select", function (e: Event) {
  const event = e as ShopifyEvent;
  const section_id = event.detail.sectionId;
  const section_container = (event.target as HTMLElement).querySelector(`[data-section-id='${section_id}']`) as ShopifyWebComponentSection;
...
document.addEventListener("shopify:block:deselect", function (e: Event) {
  const event = e as ShopifyEvent;
  const section_id = event.detail.sectionId;
  const section_container = (event.target as HTMLElement).querySelector(`[data-section-id='${section_id}']`) as ShopifyWebComponentSection;
